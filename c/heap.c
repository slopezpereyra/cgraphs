...
/**
 * @brief Ensures the min-heap property for the heap starting from a specified index.
 *
 ...
 * min-heap property. It performs the necessary swaps to maintain the heap structure.
 *
 ...
 *
 * Removes and returns the root element of the heap (minimum value in a min-heap).
 * After removal, the heap is adjusted to maintain the min-heap property.
 *
 * @param heap Pointer to the heap structure.
 * @return The minimum node in the heap, or a node with label 0 and value -1 if the heap is empty.
 *
